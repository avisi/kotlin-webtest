...
class HttpStatusValidator(val range: ClosedRange<Int>) : Validator<HttpRequest, HttpResponse> {
    override fun validate(executionContext: ExecutionContext, request: HttpRequest, response: HttpResponse): ValidatorResult {
...
class HttpStatusValidationBuilder<RequestType : HttpRequest, ResponseType : HttpResponse>(private val step: TestStep<RequestType, ResponseType>) {
